...
public class Tutorial {
    //this is the tutorial it looks like your computer is lagging if you use this on intellij, when executed in cmd using normal javac, it looks really smooth
